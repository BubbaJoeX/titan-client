...
# Fallback: use FindMaya when devkit package doesn't have Maya SDK (e.g. Maya 2026 from standard install)
if(NOT DEVKIT_LIBRARY_DIR OR NOT DEVKIT_INCLUDE_DIR)
  find_package(Maya REQUIRED)
  if(MAYA_FOUND)
    set(DEVKIT_LIBRARY_DIR ${MAYA_LIBRARY_DIR})
    set(DEVKIT_INCLUDE_DIR ${MAYA_INCLUDE_DIR})
    message(STATUS "Using Maya SDK from: ${MAYA_BASE_DIR}")
  endif()
endif()
...
add_definitions (${DEVKIT_PLATFORM_FLAGS})
