...
public:
	...
	MVertexBuffer* createVertexBuffer(const MVertexBufferDescriptor& desc, bool useBufferFromDesc);
...
public:
	...
	MVertexBuffer(const MVertexBufferDescriptor& descriptor, bool softwareStaged, bool useBufferFromDesc);
