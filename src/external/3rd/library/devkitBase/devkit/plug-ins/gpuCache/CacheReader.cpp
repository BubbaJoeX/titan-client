...
public:
    ...
    public:
        ...
        void cancelTask()
        {
            // empty fTask signifies that the task has been enqueued.
            assert(!fTask);
            fCancelled = true;
        }
    ...
    )
    {
        ...
        WorkItem::Ptr item(new WorkItem(this, entry, geometryPath, proxy, fArena));
