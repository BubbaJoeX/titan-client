namespace metadata
{
	partial class StreamForm
	{
		...
		private void InitializeComponent()
		{
			...
			// StreamName
			// 
			this.StreamName.HeaderText = "Name";
			this.StreamName.Name = "StreamName";
			this.StreamName.ReadOnly = true;
			this.StreamName.Width = 200;
			// 
			// StructName
			// 
			this.StructName.HeaderText = "Struct";
			this.StructName.Name = "StructName";
			this.StructName.ReadOnly = true;
			this.StructName.Width = 200;
			// 
			// Count
			// 
			this.Count.HeaderText = "Handle Count";
