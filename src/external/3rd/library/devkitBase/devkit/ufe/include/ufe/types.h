...
template <typename T, std::size_t SZ> struct UFE_SDK_DECL TypedVectorN;
template <typename T, std::size_t SZ> struct UFE_SDK_DECL TypedColorN;

template <typename T, std::size_t SZ>
UFE_SDK_DECL std::istream& operator>>(std::istream& is, TypedVectorN<T,SZ>& v);
template <typename T, std::size_t SZ>
UFE_SDK_DECL std::ostream& operator<<(std::ostream& os, const TypedVectorN<T,SZ>& v);

template <typename T, std::size_t SZ>
UFE_SDK_DECL std::istream& operator>>(std::istream& is, TypedColorN<T,SZ>& c);
template <typename T, std::size_t SZ>
UFE_SDK_DECL std::ostream& operator<<(std::ostream& os, const TypedColorN<T,SZ>& c);
...
struct UFE_SDK_DECL TypedVectorN
{
    ...
    // Stream insert/extract operators so we can store this in Ufe::Value.
    UFE_SDK_DECL friend std::istream& operator>><>(std::istream& is, TypedVectorN<T,SZ>& v);
    UFE_SDK_DECL friend std::ostream& operator<<<>(std::ostream& os, const TypedVectorN<T,SZ>& v);
};
...
struct UFE_SDK_DECL TypedColorN
{
    ...
    // Stream insert/extract operators so we can store this in Ufe::Value.
    UFE_SDK_DECL friend std::istream& operator>><>(std::istream& is, TypedColorN<T,SZ>& c);
    UFE_SDK_DECL friend std::ostream& operator<<<>(std::ostream& os, const TypedColorN<T,SZ>& c);
};
