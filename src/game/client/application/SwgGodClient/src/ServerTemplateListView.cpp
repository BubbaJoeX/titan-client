 ...
 */
void ServerTemplateListView::onSearchTextChanged(const QString& text)
{
 ...
 */
void ServerTemplateListView::onClearSearch()
{
	m_currentSearchText = "";
	showAllItems(firstChild());
	triggerUpdate();
 ...
 */
bool ServerTemplateListView::filterTreeItem(QListViewItem* item, const QString& filterText) const
{
	if(item == 0)
		return false;
 ...
 */
void ServerTemplateListView::showAllItems(QListViewItem* item) const
{
	while(item)
	{
