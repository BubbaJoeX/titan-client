...
public:
    ...
    VectorArgb(void);
    VectorArgb(float newA, float newR, float newG, float newB);
    VectorArgb(const PackedArgb &argb);

    void set(float newA, float newR, float newG, float newB);
    ...
    static const VectorArgb linearInterpolate(const VectorArgb &color1, const VectorArgb &color2, float time);
...
inline VectorArgb::VectorArgb(float newA, float newR, float newG, float newB)
        : a(newA),
          r(newR),
          g(newG),
          b(newB)
...
inline void VectorArgb::set(float newA, float newR, float newG, float newB)
{
    a = newA;
    r = newR;
    g = newG;
...
inline const VectorArgb VectorArgb::linearInterpolate(const VectorArgb &color1, const VectorArgb &color2, float time)
{
