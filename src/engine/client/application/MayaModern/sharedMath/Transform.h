...
public:
    ...
    void           ypr_l(float y, float p, float r);
    ...
    void           setPosition_p(float x, float y, float z);
...
inline void Transform::setPosition_p(float x, float y, float z)
{
    matrix[0][3] = x;
    matrix[1][3] = y;
    matrix[2][3] = z;
...
{
    const float x = vec.x - matrix[0][3];
    const float y = vec.y - matrix[1][3];
    const float z = vec.z - matrix[2][3];
