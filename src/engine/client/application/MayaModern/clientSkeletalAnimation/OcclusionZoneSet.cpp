...
namespace
{
    ...
    public:
        ...
        public:
            ...
            bool operator()(const std::shared_ptr<OcclusionZone> &lhs, const std::shared_ptr<OcclusionZone> &rhs) const;
            bool operator()(const std::shared_ptr<OcclusionZone> &lhs, const std::shared_ptr<CrcLowerString> &rhs) const;
            bool operator()(const std::shared_ptr<CrcLowerString> &lhs, const std::shared_ptr<OcclusionZone> &rhs) const;
            
            };
    
    public:
        
        OcclusionZone(const std::shared_ptr<CrcLowerString> &name, int id);
    ...
    typedef std::vector<std::shared_ptr<OcclusionZone>>                     OcclusionZoneVector;
...
inline bool OcclusionZone::LessNameComparator::operator()(const std::shared_ptr<OcclusionZone> &lhs, const std::shared_ptr<OcclusionZone> &rhs) const
{
...
inline bool OcclusionZone::LessNameComparator::operator()(const std::shared_ptr<OcclusionZone> &lhs, const std::shared_ptr<CrcLowerString> &rhs) const
{
...
inline bool OcclusionZone::LessNameComparator::operator()(const std::shared_ptr<CrcLowerString> &lhs, const std::shared_ptr<OcclusionZone> &rhs) const
{
...
OcclusionZone::OcclusionZone(const std::shared_ptr<CrcLowerString> &name, int id)
        :	m_name(name),
        m_id(id)
{
}
...
void OcclusionZoneSet::registerOcclusionZones(const CrcLowerStringVector &occlusionZoneNames, IntVector &occlusionZoneIds)
{
    ...
    for (CrcLowerStringVector::const_iterator testIt = occlusionZoneNames.begin(); testIt != testItEnd; ++testIt)
    {
        ...
        if (findResult.first == findResult.second)
        {
            ...
            //-- create the zone
            std::shared_ptr<OcclusionZone> newOcclusionZone(new OcclusionZone(*testIt, newZoneId));
