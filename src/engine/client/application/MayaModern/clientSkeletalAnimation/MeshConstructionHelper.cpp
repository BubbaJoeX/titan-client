...
public:
    ...
    typedef std::map<CrcString*, std::shared_ptr<MeshConstructionHelper::PerShaderData>, LessPointerComparator>  Container;
...
namespace
{
    ...
    public:
        ...
        AffectedShaderData(std::shared_ptr<MeshConstructionHelper::PerShaderData> affectedShader, Tag shaderTextureTag);

    public:

        std::shared_ptr<MeshConstructionHelper::PerShaderData> m_affectedShader;
...
namespace
{
    AffectedShaderData::AffectedShaderData(std::shared_ptr<MeshConstructionHelper::PerShaderData> affectedShader, Tag shaderTextureTag)
            :	m_affectedShader(std::move(affectedShader)),
...
void MeshConstructionHelper::prepareForReading(void)
{
    ...
    {
        for (auto it = m_perShaderData->m_container.begin(); it != m_perShaderData->m_container.end(); it++)
        {
            std::shared_ptr<PerShaderData> psd = (*it).second;
            NOT_NULL(psd);
    ...
    if (DEBUG_REPORT_ENGINE_FLAG(characterSystem))
	{
		...
		for (auto it = m_vertexData->m_container.begin(); it != m_vertexData->m_container.end(); ++it)
		{
...
void MeshConstructionHelper::addPositionWeight(int positionIndex, int transformIndex, float weight)
{
    NOT_NULL(m_transformHeaders);
...
std::shared_ptr<MeshConstructionHelper::PerShaderData> MeshConstructionHelper::addShaderTemplate(const char *shaderTemplateName)
{
    ...
    auto psd = std::make_shared<PerShaderData>(shaderTemplateName);
...
void MeshConstructionHelper::setVertexFormat(std::shared_ptr<PerShaderData> perShaderData, uint shaderVertexFormat)
{
...
void MeshConstructionHelper::setTextureCoordinateSetCount(std::shared_ptr<PerShaderData> perShaderData, int setCount)
{
    NOT_NULL(perShaderData);
...
void MeshConstructionHelper::setTextureCoordinateDimensionality(std::shared_ptr<PerShaderData> perShaderData, int setIndex, int dimensionality)
{
    NOT_NULL(perShaderData);
...
int MeshConstructionHelper::getNextNewVertexIndex(const std::shared_ptr<PerShaderData> perShaderData) const
{
    NOT_NULL(perShaderData);
...
void MeshConstructionHelper::addVertexPosition(std::shared_ptr<PerShaderData> perShaderData, int positionIndex)
{
    NOT_NULL(perShaderData);
...
void MeshConstructionHelper::setVertexNormal(std::shared_ptr<PerShaderData> perShaderData, int shaderVertexIndex, int normalIndex)
{
    NOT_NULL(m_normals);
    NOT_NULL(perShaderData);
    NOT_NULL(m_vertexData);
...
void MeshConstructionHelper::setVertexColor(std::shared_ptr<PerShaderData> perShaderData, int shaderVertexIndex, const PackedArgb &color)
{
    NOT_NULL(perShaderData);
    NOT_NULL(m_vertexData);
...
void MeshConstructionHelper::setTextureCoordinates(std::shared_ptr<PerShaderData> perShaderData, int shaderVertexIndex, int tcSetIndex, float tc0)
{
    NOT_NULL(perShaderData);
    NOT_NULL(m_vertexData);
...
void MeshConstructionHelper::setTextureCoordinates(std::shared_ptr<PerShaderData> perShaderData, int shaderVertexIndex, int tcSetIndex, float tc0, float tc1)
{
    NOT_NULL(perShaderData);
    NOT_NULL(m_vertexData);
    VALIDATE_RANGE_INCLUSIVE_EXCLUSIVE(0, tcSetIndex, perShaderData->m_textureCoordinateSetCount);
...
void MeshConstructionHelper::setTextureCoordinates(std::shared_ptr<PerShaderData> perShaderData, int shaderVertexIndex, int tcSetIndex, float tc0, float tc1, float tc2)
{
    NOT_NULL(perShaderData);
    NOT_NULL(m_vertexData);
    VALIDATE_RANGE_INCLUSIVE_EXCLUSIVE(0, tcSetIndex, perShaderData->m_textureCoordinateSetCount);
...
void MeshConstructionHelper::setTextureCoordinates(std::shared_ptr<PerShaderData> perShaderData, int shaderVertexIndex, int tcSetIndex, float tc0, float tc1, float tc2, float tc3)
{
    NOT_NULL(perShaderData);
    NOT_NULL(m_vertexData);
    VALIDATE_RANGE_INCLUSIVE_EXCLUSIVE(0, tcSetIndex, perShaderData->m_textureCoordinateSetCount);
...
int MeshConstructionHelper::addTriStrip(std::shared_ptr<PerShaderData> perShaderData, bool flipCullMode)
{
    NOT_NULL(perShaderData);
...
void MeshConstructionHelper::addTriStripVertex(std::shared_ptr<PerShaderData> perShaderData, int triStripIndex, int shaderVertexIndex)
{
    NOT_NULL(m_triStripHeaders);
    NOT_NULL(m_triStripIndices);
    NOT_NULL(m_vertexData);
...
MeshConstructionHelper::TriListHeader &MeshConstructionHelper::addTriList(std::shared_ptr<PerShaderData> perShaderData)
{
    NOT_NULL(perShaderData);
...
void MeshConstructionHelper::addTriListTri(std::shared_ptr<PerShaderData> perShaderData, TriListHeader &triList, int indexV0, int indexV1, int indexV2)
{
    NOT_NULL(perShaderData);
...
std::shared_ptr<MeshConstructionHelper::PerShaderData> MeshConstructionHelper::getPerShaderData(int shaderIndex) const
{
    ...
    return nullptr; //lint !e527 // unreachable // in debug
}

// ------------------------------------------------------------------

const CrcString &MeshConstructionHelper::getShaderTemplateName(const std::shared_ptr<PerShaderData> perShaderData) const
{
    NOT_NULL(perShaderData);
...
uint MeshConstructionHelper::getVertexFormat(const std::shared_ptr<PerShaderData> perShaderData) const
{
    NOT_NULL(perShaderData);
...
int MeshConstructionHelper::getTextureCoordinateSets(const std::shared_ptr<PerShaderData> perShaderData) const
{
    NOT_NULL(perShaderData);
...
int MeshConstructionHelper::getTextureCoordinateDimensionality(const std::shared_ptr<PerShaderData> perShaderData, int setIndex) const
{
    NOT_NULL(perShaderData);
    VALIDATE_RANGE_INCLUSIVE_EXCLUSIVE(0, setIndex, perShaderData->m_textureCoordinateSetCount);
...
int MeshConstructionHelper::getNumberOfTransformWeightPairs(const std::shared_ptr<PerShaderData> perShaderData) const
{
    NOT_NULL(perShaderData);
...
int MeshConstructionHelper::getNumberOfWeightedPrimitiveIndices(const std::shared_ptr<PerShaderData> perShaderData) const
{
    NOT_NULL(perShaderData);
...
int MeshConstructionHelper::getVertexCount(const std::shared_ptr<PerShaderData> perShaderData) const
{
    NOT_NULL(perShaderData);
...
const MeshConstructionHelper::VertexData &MeshConstructionHelper::getVertexData(const std::shared_ptr<PerShaderData> perShaderData, int shaderVertexIndex) const
{
    NOT_NULL(perShaderData);
    NOT_NULL(m_vertexData);
...
void MeshConstructionHelper::getTextureCoordinates(const std::shared_ptr<PerShaderData> perShaderData, const VertexData &vertexData, int textureCoordinateSet, float &tc0) const
{
    NOT_NULL(perShaderData);
    NOT_NULL(m_textureCoordinates);
...
void MeshConstructionHelper::getTextureCoordinates(const std::shared_ptr<PerShaderData> perShaderData, const VertexData &vertexData, int textureCoordinateSet, float &tc0, float &tc1) const
{
    NOT_NULL(perShaderData);
    NOT_NULL(m_textureCoordinates);
    VALIDATE_RANGE_INCLUSIVE_EXCLUSIVE(0, textureCoordinateSet, perShaderData->m_textureCoordinateSetCount);
...
void MeshConstructionHelper::getTextureCoordinates(const std::shared_ptr<PerShaderData> perShaderData, const VertexData &vertexData, int textureCoordinateSet, float &tc0, float &tc1, float &tc2) const
{
    NOT_NULL(perShaderData);
    NOT_NULL(m_textureCoordinates);
    VALIDATE_RANGE_INCLUSIVE_EXCLUSIVE(0, textureCoordinateSet, perShaderData->m_textureCoordinateSetCount);
...
void MeshConstructionHelper::getTextureCoordinates(const std::shared_ptr<PerShaderData> perShaderData, const VertexData &vertexData, int textureCoordinateSet, float &tc0, float &tc1, float &tc2, float &tc3) const
{
    NOT_NULL(perShaderData);
    NOT_NULL(m_textureCoordinates);
    VALIDATE_RANGE_INCLUSIVE_EXCLUSIVE(0, textureCoordinateSet, perShaderData->m_textureCoordinateSetCount);
...
int MeshConstructionHelper::getTriStripCount(const std::shared_ptr<PerShaderData> perShaderData) const
{
    NOT_NULL(perShaderData);
...
const MeshConstructionHelper::TriStripHeader &MeshConstructionHelper::getTriStrip(const std::shared_ptr<PerShaderData> perShaderData, int triStripIndex) const
{
    NOT_NULL(perShaderData);
    NOT_NULL(m_triStripHeaders);
...
int MeshConstructionHelper::getTriListCount(const std::shared_ptr<PerShaderData> perShaderData) const
{
    NOT_NULL(perShaderData);
...
const MeshConstructionHelper::TriListHeader &MeshConstructionHelper::getTriList(const std::shared_ptr<PerShaderData> perShaderData, int triListIndex) const
{
    NOT_NULL(m_triListHeaders);
    NOT_NULL(perShaderData);
...
void MeshConstructionHelper::getTriListTriangle(const std::shared_ptr<PerShaderData> perShaderData, const TriListHeader &triListHeader, int triIndex, int &index0, int &index1, int &index2) const
{
...
void MeshConstructionHelper::addAffectedShaderTemplate(PerTextureRendererData *perTextureRendererData, Tag shaderTextureTag, std::shared_ptr<PerShaderData> perShaderData)
{
