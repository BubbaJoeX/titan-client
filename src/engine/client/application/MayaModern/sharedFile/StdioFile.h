...
public:
    ...
    virtual int  write(unsigned int num_bytes, const void* source_buffer);
    virtual void flush();
...
{
public:
    virtual std::shared_ptr<AbstractFile> createFile(const char *filename, const char *openType);
};
