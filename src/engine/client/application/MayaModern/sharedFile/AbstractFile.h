...
public:
     ...
     */
    virtual int write(unsigned int numberOfBytes, const void *sourceBuffer) = 0;
...
{
public:
    virtual std::shared_ptr<AbstractFile> createFile(const char *filename, const char *openType) = 0;
};
