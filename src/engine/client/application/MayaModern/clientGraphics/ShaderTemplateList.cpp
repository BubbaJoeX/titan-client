...
{
    ms_2dVertexColorStaticShader     = dynamic_cast<const StaticShader*>(fetchShader("shader/2d_vertexcolor.sht"));
    ms_2dVertexColorAStaticShader    = dynamic_cast<const StaticShader*>(fetchShader("shader/2d_vertexcolora.sht"));
    ms_3dVertexColorStaticShader     = dynamic_cast<const StaticShader*>(fetchShader("shader/3d_vertexcolor.sht"));
    ms_3dVertexColorAStaticShader    = dynamic_cast<const StaticShader*>(fetchShader("shader/3d_vertexcolora.sht"));
    ms_3dVertexColorACStaticShader   = dynamic_cast<const StaticShader*>(fetchShader("shader/3d_vertexcolorac.sht"));
    ms_3dVertexColorAZStaticShader   = dynamic_cast<const StaticShader*>(fetchShader("shader/3d_vertexcoloraz.sht"));
    ms_3dVertexColorZStaticShader    = dynamic_cast<const StaticShader*>(fetchShader("shader/3d_vertexcolorz.sht"));
    ms_3dVertexColorLZStaticShader   = dynamic_cast<const StaticShader*>(fetchShader("shader/3d_vertexcolorlz.sht"));
    ms_badVertexShaderStaticShader   = dynamic_cast<const StaticShader*>(fetchShader("shader/bad_vertex_shader.sht"));
}
...
void ShaderTemplateList::releaseVertexColorShaderTemplates()
{
    ...
    {
        ms_2dVertexColorStaticShader = nullptr;
        ms_2dVertexColorAStaticShader = nullptr;
        ms_3dVertexColorStaticShader = nullptr;
        ms_3dVertexColorAStaticShader = nullptr;
        ms_3dVertexColorACStaticShader = nullptr;
        ms_3dVertexColorAZStaticShader = nullptr;
        ms_3dVertexColorZStaticShader = nullptr;
        ms_3dVertexColorLZStaticShader = nullptr;
        ms_badVertexShaderStaticShader = nullptr;
    }
}
...
ShaderTemplate *ShaderTemplateList::create(const CrcString &name, Iff &iff)
{
    ...
    IGNORE_RETURN(_snprintf(s_crashReportInfoLoadFromIff, sizeof(s_crashReportInfoLoadFromIff) - 1, "ShaderTemplate_Iff: %s\n", (filename && *filename) ? filename : "<NULL>"));
