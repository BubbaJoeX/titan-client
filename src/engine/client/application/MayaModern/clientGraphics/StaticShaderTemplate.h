...
public:
    ...
    typedef std::map<Tag, Material>       MaterialMap;
    typedef std::map<Tag, TextureData>    TextureDataMap;
    typedef std::map<Tag, uint8>          TextureCoordinateSetMap;
    typedef std::map<Tag, uint32>         TextureFactorMap;
    typedef std::map<Tag, TextureScroll>  TextureScrollMap;
    typedef std::map<Tag, uint8>          AlphaTestReferenceValueMap;
    typedef std::map<Tag, uint32>         StencilReferenceValueMap;
