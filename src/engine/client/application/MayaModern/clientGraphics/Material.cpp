...
Material::Material(const VectorArgb &newAmbientColor, const VectorArgb &newDiffuseColor, const VectorArgb &newEmissiveColor, const VectorArgb &newSpecularColor, float newSpecularPower) :
