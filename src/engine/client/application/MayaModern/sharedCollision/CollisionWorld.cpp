...
/**
 * @return true if this scene should force reattach contacts to the floor after sweeps
 * (e.g., Kashyyyk Fallthrough prevention if it worked correctly).
 *
 * @see FootprintForceReattachManager.cpp
 */
bool CollisionWorld::isForceReattachScene()
{
	return ms_forceReattachContactsPostResolve;
}
